...
//     @BeforeEach
//     public void before() {
//         final DefaultTaggedMetricRegistry taggedMetrics = new DefaultTaggedMetricRegistry();
//         channel = new BalancedNodeSelectionStrategyChannel(
//                 ImmutableList.of(chan1, chan2),
//                 new BalancedScoreTracker(
//                         ImmutableList.of(chan1, chan2).size(), random, clock, taggedMetrics, "channelName"));
//         final DefaultTaggedMetricRegistry taggedMetrics1 = new DefaultTaggedMetricRegistry();
//         rttChannel = new BalancedNodeSelectionStrategyChannel(
//                 ImmutableList.of(chan1, chan2),
//                 new BalancedScoreTracker(
//                         ImmutableList.of(chan1, chan2).size(), random, clock, taggedMetrics1, "channelName"));
//     }
//
//     @Test
