...
/**
 * The contract of {@link EndpointChannel} requires that the {@link EndpointChannel#execute} method never throws.
...
final class NeverThrowEndpointChannel implements EndpointChannel {
    ...
    NeverThrowEndpointChannel(EndpointChannel delegate) {
