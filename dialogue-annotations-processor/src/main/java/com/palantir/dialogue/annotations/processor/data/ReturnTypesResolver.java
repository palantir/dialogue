...
public final class ReturnTypesResolver {
    ...
    public ReturnTypesResolver(ErrorContext errorContext, Types types) {
        this.errorContext = errorContext;
        this.types = types;
    }

    public Optional<ReturnType> getReturnType(AnnotationReflector _requestAnnotation, TypeMirror returnType) {
