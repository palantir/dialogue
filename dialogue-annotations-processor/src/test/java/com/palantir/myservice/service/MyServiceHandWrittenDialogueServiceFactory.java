...
public final class MyServiceHandWrittenDialogueServiceFactory implements DialogueServiceFactory<MyService> {
    ...
    public MyService create(EndpointChannelFactory endpointChannelFactory, ConjureRuntime runtime) {
        return new MyService() {
            ...
            private final Deserializer<Response> customResponseDeserializer = new MyResponseDeserializer();
