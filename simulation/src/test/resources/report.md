...
```
                all_nodes_500[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=79.3%	client_mean=PT3.08354S     	server_cpu=PT20M          	client_received=2000/2000	server_resps=2000	codes={200=1586, 500=414}
                    all_nodes_500[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=73.2%	client_mean=PT2.21873S     	server_cpu=PT20M          	client_received=2000/2000	server_resps=2000	codes={200=1463, 500=537}
                   ...
                   black_hole[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=56.9%	client_mean=PT0.6S         	server_cpu=PT11M22.8S     	client_received=1138/2000	server_resps=1138	codes={200=1138}
                       black_hole[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=89.7%	client_mean=PT0.600044617S 	server_cpu=PT17M55.8S     	client_received=1793/2000	server_resps=1793	codes={200=1793}
                                 black_hole[UNLIMITED_ROUND_ROBIN].txt:	success=59.5%	client_mean=PT0.6S         	server_cpu=PT11M54S       	client_received=1190/2000	server_resps=1190	codes={200=1190}
             drastic_slowdown[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT1.965733249S 	server_cpu=PT41M8.192999979S	client_received=4000/4000	server_resps=4000	codes={200=4000}
                 drastic_slowdown[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT2.084016583S 	server_cpu=PT2H18M56.066333312S	client_received=4000/4000	server_resps=4000	codes={200=4000}
                           drastic_slowdown[UNLIMITED_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT16.863789083S	server_cpu=PT18H44M15.156333312S	client_received=4000/4000	server_resps=4000	codes={200=4000}
        fast_500s_then_revert[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=99.9%	client_mean=PT0.078624177S 	server_cpu=PT4M54.840666665S	client_received=3750/3750	server_resps=3750	codes={200=3746, 500=4}
            fast_500s_then_revert[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=93.7%	client_mean=PT0.070029333S 	server_cpu=PT4M22.609999873S	client_received=3750/3750	server_resps=3750	codes={200=3513, 500=237}
                      fast_500s_then_revert[UNLIMITED_ROUND_ROBIN].txt:	success=92.8%	client_mean=PT0.068868444S 	server_cpu=PT4M18.256666533S	client_received=3750/3750	server_resps=3750	codes={200=3481, 500=269}
               live_reloading[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=97.2%	client_mean=PT4.8253936S   	server_cpu=PT2H46.79S     	client_received=2500/2500	server_resps=2500	codes={200=2430, 500=70}
                   live_reloading[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=90.2%	client_mean=PT3.6602976S   	server_cpu=PT1H56M54.23S  	client_received=2500/2500	server_resps=2500	codes={200=2254, 500=246}
                             live_reloading[UNLIMITED_ROUND_ROBIN].txt:	success=58.8%	client_mean=PT2.842428S    	server_cpu=PT1H58M26.07S  	client_received=2500/2500	server_resps=2500	codes={200=1469, 500=1031}
                one_big_spike[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT1.135007332S 	server_cpu=PT2M49.65S     	client_received=1000/1000	server_resps=1131	codes={200=1000}
                    one_big_spike[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT0.73789002S  	server_cpu=PT2M45S        	client_received=1000/1000	server_resps=1100	codes={200=1000}
                              one_big_spike[UNLIMITED_ROUND_ROBIN].txt:	success=85.0%	client_mean=PT2.395778146S 	server_cpu=PT11M44.55S    	client_received=1000/1000	server_resps=4697	codes={200=850, 429=150}
one_endpoint_dies_on_each_server[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=64.4%	client_mean=PT2.6866096S   	server_cpu=PT25M          	client_received=2500/2500	server_resps=2500	codes={200=1611, 500=889}
 one_endpoint_dies_on_each_server[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=65.6%	client_mean=PT0.8981888S   	server_cpu=PT25M          	client_received=2500/2500	server_resps=2500	codes={200=1639, 500=861}
       ...
       simplest_possible_case[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT0.799924242S 	server_cpu=PT2H55M59S     	client_received=13200/13200	server_resps=13200	codes={200=13200}
           simplest_possible_case[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT0.832212121S 	server_cpu=PT3H3M5.2S     	client_received=13200/13200	server_resps=13200	codes={200=13200}
                     simplest_possible_case[UNLIMITED_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT0.832212121S 	server_cpu=PT3H3M5.2S     	client_received=13200/13200	server_resps=13200	codes={200=13200}
        slow_503s_then_revert[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT0.137438962S 	server_cpu=PT6M39.829999979S	client_received=3000/3000	server_resps=3077	codes={200=3000}
            slow_503s_then_revert[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT0.344538482S 	server_cpu=PT16M46.462666643S	client_received=3000/3000	server_resps=3203	codes={200=3000}
                      slow_503s_then_revert[UNLIMITED_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT3.202041794S 	server_cpu=PT2H35M29.714333312S	client_received=3000/3000	server_resps=4757	codes={200=3000}
slowdown_and_error_thresholds[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=99.8%	client_mean=PT3M9.775496352S	server_cpu=PT13H15M43.393332383S	client_received=10000/10000	server_resps=15825	codes={200=9978, 500=22}
    slowdown_and_error_thresholds[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=99.9%	client_mean=PT3M14.1333444S	server_cpu=PT14H31M44.673332991S	client_received=10000/10000	server_resps=15307	codes={200=9990, 500=10}
              slowdown_and_error_thresholds[UNLIMITED_ROUND_ROBIN].txt:	success=1.2%	client_mean=PT20.36320314S 	server_cpu=PT51H22M9.19999998S	client_received=10000/10000	server_resps=50000	codes={200=120, 500=9880}
