...
```
                all_nodes_500[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=50.0%	client_mean=PT0.6S         	server_cpu=PT20M          	client_received=2000/2000	server_resps=2000	codes={200=1000, 500=1000}
                   ...
                   black_hole[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT0.6S         	server_cpu=PT20M          	client_received=2000/2000	server_resps=2000	codes={200=2000}
                       black_hole[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=80.0%	client_mean=PT0.6S         	server_cpu=PT16M          	client_received=1600/2000	server_resps=1600	codes={200=1600}
                                 black_hole[UNLIMITED_ROUND_ROBIN].txt:	success=60.3%	client_mean=PT0.6S         	server_cpu=PT12M3.6S      	client_received=1206/2000	server_resps=1206	codes={200=1206}
             drastic_slowdown[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT2.053273999S 	server_cpu=PT2H16M53.095999975S	client_received=4000/4000	server_resps=4000	codes={200=4000}
                 drastic_slowdown[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT4.041505689S 	server_cpu=PT4H29M19.605999961S	client_received=4000/4000	server_resps=4000	codes={200=4000}
                           drastic_slowdown[UNLIMITED_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT6.998042749S 	server_cpu=PT7H46M32.170999961S	client_received=4000/4000	server_resps=4000	codes={200=4000}
        fast_500s_then_revert[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=99.7%	client_mean=PT0.080628266S 	server_cpu=PT5M2.355999997S	client_received=3750/3750	server_resps=3750	codes={200=3739, 500=11}
            fast_500s_then_revert[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=77.4%	client_mean=PT0.05288791S  	server_cpu=PT3M18.329666241S	client_received=3750/3750	server_resps=3750	codes={200=2901, 500=849}
                      fast_500s_then_revert[UNLIMITED_ROUND_ROBIN].txt:	success=77.4%	client_mean=PT0.05288791S  	server_cpu=PT3M18.329666241S	client_received=3750/3750	server_resps=3750	codes={200=2901, 500=849}
          ...
          one_big_spike[CONCURRENCY_LIMITER_BLACKLIST_ROUND_ROBIN].txt:	success=79.0%	client_mean=PT1.478050977S 	server_cpu=PT1M59.71393673S	client_received=1000/1000	server_resps=790	codes={200=790, Failed to make a request=210}
                one_big_spike[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=92.4%	client_mean=PT1.301512433S 	server_cpu=PT2M18.6S      	client_received=1000/1000	server_resps=924	codes={200=924, Failed to make a request=76}
                    one_big_spike[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=92.4%	client_mean=PT1.274480608S 	server_cpu=PT2M18.6S      	client_received=1000/1000	server_resps=924	codes={200=924, Failed to make a request=76}
                              one_big_spike[UNLIMITED_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT0.557882494S 	server_cpu=PT5M36.75S     	client_received=1000/1000	server_resps=2245	codes={200=1000}
one_endpoint_dies_on_each_server[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=65.6%	client_mean=PT0.6S         	server_cpu=PT25M          	client_received=2500/2500	server_resps=2500	codes={200=1639, 500=861}
 one_endpoint_dies_on_each_server[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=65.6%	client_mean=PT0.6S         	server_cpu=PT25M          	client_received=2500/2500	server_resps=2500	codes={200=1641, 500=859}
           one_endpoint_dies_on_each_server[UNLIMITED_ROUND_ROBIN].txt:	success=65.6%	client_mean=PT0.6S         	server_cpu=PT25M          	client_received=2500/2500	server_resps=2500	codes={200=1641, 500=859}
       simplest_possible_case[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT0.6S         	server_cpu=PT2H12M        	client_received=13200/13200	server_resps=13200	codes={200=13200}
        ...
        slow_503s_then_revert[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=100.0%	client_mean=PT0.075948S    	server_cpu=PT3M47.844S    	client_received=3000/3000	server_resps=3000	codes={200=3000}
            slow_503s_then_revert[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT0.966938577S 	server_cpu=PT46M57.491999957S	client_received=3000/3000	server_resps=3589	codes={200=3000}
                      slow_503s_then_revert[UNLIMITED_ROUND_ROBIN].txt:	success=100.0%	client_mean=PT1.165795358S 	server_cpu=PT56M39.578999957S	client_received=3000/3000	server_resps=3697	codes={200=3000}
slowdown_and_error_thresholds[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=1.2%	client_mean=PT2.868860775S 	server_cpu=PT4H1M13.19999998S	client_received=10000/10000	server_resps=3824	codes={200=120, 500=3704, Failed to make a request=6176}
    slowdown_and_error_thresholds[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=1.2%	client_mean=PT2.843309007S 	server_cpu=PT4H40.19999998S	client_received=10000/10000	server_resps=3801	codes={200=120, 500=3681, Failed to make a request=6199}
              ...
              uncommon_flakes[CONCURRENCY_LIMITER_PIN_UNTIL_ERROR].txt:	success=99.1%	client_mean=PT0.000001S    	server_cpu=PT0.01S        	client_received=10000/10000	server_resps=10000	codes={200=9905, 500=95}
                  uncommon_flakes[CONCURRENCY_LIMITER_ROUND_ROBIN].txt:	success=99.1%	client_mean=PT0.000001S    	server_cpu=PT0.01S        	client_received=10000/10000	server_resps=10000	codes={200=9910, 500=90}
                            uncommon_flakes[UNLIMITED_ROUND_ROBIN].txt:	success=99.1%	client_mean=PT0.000001S    	server_cpu=PT0.01S        	client_received=10000/10000	server_resps=10000	codes={200=9910, 500=90}
```
