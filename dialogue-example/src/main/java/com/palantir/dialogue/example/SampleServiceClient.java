...
public final class SampleServiceClient {
    ...
    /**
     * Returns a new blocking {@link SampleService} implementation whose calls are executed on the given channel. The
     * {@code callTimeout} parameter indicates the maximum end-to-end life time for the blocking methods in this
