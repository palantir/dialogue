 ...
 *
 * Implementations of {@link Channel#execute(Endpoint, Request)} must return immediately, and must not perform blocking
 * operations. Channel implementations using blocking constructs must internally leverage an executor to expose only a
 * non-blocking API.
 *
 * <h4>Behavior</h4>
 *
